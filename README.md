...
'python demo.py 192.168.31.126 cert/ca-cert.pem cert/client-key.pem cert/client-cert.pem'

python grpc_teleop.py 192.168.31.126 cert/ca-cert.pem cert/client-key.pem cert/client-cert.pem 